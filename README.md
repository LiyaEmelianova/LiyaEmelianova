...
### Что я умею:
- Сбор и анализ требования заказчиков к отчётности
...
- Использование базовые конструкции языка программирования Python для решения простых алгоритмических задач
- Пишу программный код на высокоуровневом языке Python
- Работаю с аналитическими библиотеками numpy, scipy, pandas, matplotlib, seaborn
